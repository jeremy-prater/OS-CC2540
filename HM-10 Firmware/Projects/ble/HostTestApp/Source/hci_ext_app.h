...
#define HCI_EXT_LL_SET_RX_GAIN                            0x00
#define HCI_EXT_LL_SET_TX_POWER                           0x01
#define HCI_EXT_LL_ONE_PKT_PER_EVT                        0x02
#define HCI_EXT_LL_CLK_DIVIDE_ON_HALT                     0x03
#define HCI_EXT_LL_DECLARE_NV_USAGE                       0x04
#define HCI_EXT_LL_DECRYPT                                0x05
#define HCI_EXT_LL_SET_LOCAL_SUPPORTED_FEATURES           0x06
#define HCI_EXT_LL_SET_FAST_TX_RESP_TIME                  0x07
#define HCI_EXT_LL_MODEM_TEST_TX                          0x08
#define HCI_EXT_LL_MODEM_HOP_TEST_TX                      0x09
#define HCI_EXT_LL_MODEM_TEST_RX                          0x0A
#define HCI_EXT_LL_END_MODEM_TEST                         0x0B
#define HCI_EXT_LL_SET_BDADDR                             0x0C
#define HCI_EXT_LL_SET_SCA                                0x0D
#define HCI_EXT_LL_ENABLE_PTM                             0x0E // Not a supported HCI command! Application only.
#define HCI_EXT_LL_SET_FREQ_TUNE                          0x0F
#define HCI_EXT_LL_SAVE_FREQ_TUNE                         0x10
#define HCI_EXT_LL_SET_MAX_DTM_TX_POWER                   0x11
#define HCI_EXT_LL_MAP_PM_IO_PORT                         0x12
#define HCI_EXT_LL_DISCONNECT_IMMED                       0x13
#define HCI_EXT_LL_PER                                    0x14
#define HCI_EXT_LL_PER_BY_CHAN                            0x15 // Not a supported HCI command! Application only.
#define HCI_EXT_LL_EXTEND_RF_RANGE                        0x16
#define HCI_EXT_LL_ADV_EVENT_NOTICE                       0x17 // Not a supported HCI command! Application only.
#define HCI_EXT_LL_CONN_EVENT_NOTICE                      0x18 // Not a supported HCI command! Application only.
#define HCI_EXT_LL_HALT_DURING_RF                         0x19
#define HCI_EXT_LL_OVERRIDE_SL                            0x1A
#define HCI_EXT_LL_BUILD_REVISION                         0x1B
#define HCI_EXT_LL_DELAY_SLEEP                            0x1C
#define HCI_EXT_LL_RESET_SYSTEM                           0x1D
#define HCI_EXT_LL_OVERLAPPED_PROCESSING                  0x1E
#define HCI_EXT_LL_NUM_COMPLETED_PKTS_LIMIT               0x1F
